...
const DEFAULT_BACKGROUND_BASE64 = 'data:image/jpeg;base64,-';
...
userSettingsForm.addEventListener('submit', async (e) => {
    ...
    if (tempStaticBackground) {
        ...
        userUpdates.backgroundUrl = currentStaticBackground;
    }
        ...
        default: // text
          ...
          messageContentHTML = `
            <div class="px-2 py-1 rounded-2xl ${bubbleClasses} ${bubbleTailClass} backdrop-blur-md flex flex-col">
              ...
              <div class="w-full ${timeAlignmentClass}">${timeHTMLSpan}</div>
            </div>`;
      }
  ...
  if (appAccessGranted) {
    ...
    try {
        ...
        if (userDoc.exists()) {
            ...
            currentStaticBackground = userData.backgroundUrl || localStorage.getItem(STATIC_BACKGROUND_KEY);
    ...
    applyBackgroundSettings(DEFAULT_BACKGROUND_BASE64);
    showView('username-modal');
    usernameInput.focus();
  }
};
